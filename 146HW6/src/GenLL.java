...
public class GenLL <T>{
	...
	//if no nodes exist, this node becomes head
	...
	//probably doesn't work TODO remove?
	//return an array that is the current contents of the linked list.
	public T[] toArray() {
		//reset the pointer
		this.reset();
		int size = this.getSize();
		T[] ret = (T[])(new Object[size]); //trick to create a generic array since java won't let us do it.
		ListNode temp = this.head;
